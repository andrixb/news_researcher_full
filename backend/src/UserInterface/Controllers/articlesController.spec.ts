...
import { typedStub } from '../../TestHelpers/typedStub';
import makeArticlesController from './articlesController';
...
describe('articlesController', () => {
    const stubs = {
        ...
        next: jest.fn(),
        listAllArticles: typedStub<Dependencies['listAllArticles']>(),
        saveArticle: typedStub<Dependencies['saveArticle']>(),
    };
